...
export const metadata: Metadata = {
  title: 'Blog',
  description: `Shopping tips, style guides, and lifestyle articles from ${siteName}. Stay updated on fashion trends and online shopping in Ghana.`,
  openGraph: {
    title: `Blog | ${siteName}`,
    description: `Shopping tips, style guides, and lifestyle articles from ${siteName}.`,
    url: `${siteUrl}/blog`,
    images: [{ url: `${siteUrl}/opengraph-image`, width: 1200, height: 630, alt: `${siteName} Blog` }],
  },
  twitter: {
