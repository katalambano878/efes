...
const blogPosts: Record<string, { title: string; excerpt: string; category: string; author: string }> = {
  '1': { title: 'The Ultimate Guide to Online Shopping in Ghana', excerpt: 'Everything you need to know about safe, convenient online shopping in Ghana.', category: 'Shopping Tips', author: 'Ama Osei' },
  '2': { title: '10 Must-Have Products for Your Home This Season', excerpt: 'Discover the trending products that will elevate your living space.', category: 'Home & Living', author: 'Yaw Darko' },
  '3': { title: "How to Choose Quality Products: A Buyer's Guide", excerpt: 'Learn the key indicators of quality products and how to make informed purchasing decisions.', category: 'Buying Guide', author: 'Kwame Mensah' },
};
...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `${siteUrl}/blog/${id}` },
  };
}
