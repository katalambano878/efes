...
export const metadata: Metadata = {
  ...
  description: `${siteName} privacy policy. Learn how we collect, use, and protect your personal information when you shop with us.`,
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              To exercise any of these rights, please contact us via the <a href="/contact" className="text-gray-900 font-medium hover:underline">Contact page</a> or through your account settings. We will respond within 30 days.
            </p>
          </section>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="/contact" className="text-gray-900 hover:underline">See Contact page</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">See Contact page for address and details.</p>
                  </div>
                </div>
              </div>
            </div>
