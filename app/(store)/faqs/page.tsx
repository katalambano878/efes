...
export default function FAQsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'You can modify or cancel your order within 1 hour of placing it. Contact our customer service immediately via the Contact page or support ticket. Once an order is processed, modifications may not be possible.'
    },
    {
      category: 'orders',
    ...
    },
    {
      ...
      answer: 'Absolutely. We use industry-standard SSL encryption and partner with secure payment processors (Moolre, Hubtel, and Mobile Money). We never store your full card details on our servers. All transactions are PCI-DSS compliant.'
    },
    {
      category: 'payment',
