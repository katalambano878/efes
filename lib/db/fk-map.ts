// Auto-generated FK map for efes
export type FkEdge = { column: string; foreignTable: string; foreignColumn: string };
export const FK_MAP: Record<string, FkEdge[]> = {
  ...
  "exchanges": [
    ...
    { column: "new_order_id", foreignTable: "orders", foreignColumn: "id" },
    { column: "original_order_id", foreignTable: "orders", foreignColumn: "id" },
  ],
  "navigation_items": [
...
export const JSONB_COLUMNS: Record<string, Set<string>> = {
  ...
  "exchanges": new Set(["returned_items"]),
