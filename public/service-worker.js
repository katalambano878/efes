...
self.addEventListener('fetch', (event) => {
  ...
  // Product storage / uploads: network only (never poison with fallback)
  if (
  ...
  // Hashed static assets: cache-first (MIME-guard: never cache HTML as JS/CSS)
  if (
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'Efescloset', {
