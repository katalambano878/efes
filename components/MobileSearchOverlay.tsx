...
export default function MobileSearchOverlay({ isOpen, onClose }: MobileSearchOverlayProps) {
  ...
  const searchSuggestions = [
    { name: 'Summer Floral Dress', category: 'Women\'s Clothing', price: 'GH₵289', image: '/placeholder.jpg' },
    { name: 'Classic Leather Handbag', category: 'Bags', price: 'GH₵459', image: '/placeholder.jpg' },
    { name: 'Designer Sunglasses', category: 'Accessories', price: 'GH₵199', image: '/placeholder.jpg' }
  ];
